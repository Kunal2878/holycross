    ...
    return (
      <div className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-black-300 text-4xl font-bold text-center mb-10">Welcome to Holy Cross School</h1>
          <p className="text-xl text-center text-black-200 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">Cloud-Based Learning</h3>
                <p className="text-black-200">Access educational resources anytime, anywhere through our secure cloud platform</p>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="text-center">
                ...
                <p className="text-black-200">Track academic progress and achieve educational goals with personalized learning paths</p>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="text-center">
                ...
                <p className="text-black-200">Powerful tools for educators to manage classes and enhance teaching effectiveness</p>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="text-center">
                ...
                <p className="text-black-200">Comprehensive analytics and reporting for data-driven educational decisions</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-black-200">Schools Connected</p>
              </div>
              <div>
                <h3 className="text-4xl font-bold text-blue-500 mb-2">10k+</h3>
                <p className="text-black-200">Active Students</p>
              </div>
              <div>
                <h3 className="text-4xl font-bold text-blue-500 mb-2">95%</h3>
                <p className="text-black-200">Satisfaction Rate</p>
              </div>
            </div>
          </div>
        </div>
